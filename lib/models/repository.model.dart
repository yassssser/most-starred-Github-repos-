...
//
//     final reposotories = reposotoriesFromJson(jsonString);

import 'dart:convert';

Repositories reposotoriesFromJson(String str) =>
    Repositories.fromJson(json.decode(str));

String reposotoriesToJson(Repositories data) => json.encode(data.toJson());
